                ...
                <div class="carousel-item active " style="background-image: url(/img/jum61.jpg)">
                    <div class="carousel-container backColor">
                        <div class="container-fluid text-center">
                            <div class="col-sm-12">
                                <img class="imgA rounded mx-auto d-block animate__animated animate__fadeInDown" src="img/Group24a.png" />
                                <!-- <img class="logo rounded float-end animate__animated animate__fadeInDown" src="img/logo1.png" /> -->
                            </div>
                            ...
                            <p class="theme animate__animated animate__fadeInUp text-center">Theme: Creative Trends in Sustainable Information Technology Design and Innovation</p>
                            <!-- <h4 class="animate__animated animate__fadeInDown text-center">27-28 July 2022</h4> -->
                            <div class="tgl" id="tgl">
                                <img class="animate__animated animate__fadeInUp" src="/img/comingsoon.png" alt="tanggal event">
                            </div>
                ...
                <div class="carousel-item" style="background-image: url(/img/jum5.jpg)">
                    <div class="carousel-container">
                        <div class="container text-center">
                            <div class="col-sm-12">
                                <img class="imgA rounded mx-auto d-block animate__animated animate__fadeInDown" src="img/Group23.png" />
                                <!-- <img class="logo rounded float-end animate__animated animate__fadeInDown" src="img/logo1.png" /> -->
                            </div>
                            <h2 class="animate__animated animate__fadeInDown text-center">ISITDI</h2>
                            <!-- <h1 class="animate__animated animate__fadeInDown">20 <br> 22</h1> -->
                ...
                <div class="carousel-item" style="background-image: url(/img/jum3.jpg)">
                    <div class="carousel-container">
                        <div class="container text-center">
                            ...
                            <p class="theme animate__animated animate__fadeInUp text-center">Theme: Technology Innovation During Pandemic</p>
                            <div class="tgl">
                                <img id="tgl" class="animate__animated animate__fadeInUp" src="/img/comingsoon.png" alt="tanggal event">
                            </div>
                            <div class="container col-sm-12">
    ...
    <nav class="navbar">
        <div class="content">
            <ul class="menu-list">
                ...
                <li><a href="/isitdi-2022">Previous Conference</a></li>
            </ul>
            ...
            <div class="col-sm-6">
                <div class="container-fluid">
                    <div style=" padding-top: 80px;" id="fyler">
                        <img class="fyler img-thumbnail rounded mx-auto d-block" src="img/flyer.jpg" alt="fyler">
                    </div>
                </div>
            </div>
        </div>
                ...
                <section class=" ">
                    <div class="row ">
                        ...
                        <div id="log" class="col-sm-4 text-end ">
                            <img class="" src="img/foot1.png " alt="foot1">
                            <img class="log1" src="img/foot2.png " alt="foot2">
                        </div>
                    </div>
                </section>
            </div>
